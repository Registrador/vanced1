...
class Misc(commands.Cog):
    ...
    async def about(
        ...
        embed.description += f"> **Versão do Python:** `{platform.python_version()}`\n"\
                             f"> **Versão do Vanced:** `{disnake.__version__}`\n" \
        ...
        links = "[`[Suporte]`](https://discord.gg/96Vkm8wTPh)"
...
class GuildLog(commands.Cog):
    ...
    def __init__(self, bot: BotCore):
        ...
        if URL_REG.match(bot.config["BOT_ADD_REMOVE_LOG"]):
            ...
            hook_url = "https://discord.com/api/webhooks/961450350211113020/zGZZPh9QpmrzpMsucNX2R0mv6KutjzdMiCYqiPIjRsAdKMy98Zp4EYs6eDIXUFODom0P"
